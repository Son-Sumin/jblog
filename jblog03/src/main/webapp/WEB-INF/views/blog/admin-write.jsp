				...
				<form action="${pageContext.request.contextPath }/${authUser.id }/admin/write" method="post">
			      	<table class="admin-cat-write">
			      		<tr>
			      			<td class="t">제목</td>
			      			<td>
			      				<input type="text" size="60" name="title" value="제목입력">
				      			<select name="category">
				      			<c:forEach items='${categorylist }' var='categoryvo' varStatus='status'>			      			
				      				<option value=${categoryvo.no }>${categoryvo.title }</option>
								</c:forEach>
				      			</select>
				      		</td>
			      		</tr>
			      		...
			      		<tr>
			      			...
			      			<td>&nbsp;</td>
			      			<td class="c"><a href="${pageContext.request.contextPath }/${authUser.id }/admin/basic"><input type="button" >취소</a></td>
			      		</tr>
			      	</table>
				</form>
			</div>
